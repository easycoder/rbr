...
class MainWindow(QMainWindow):
    ...
    def create_row(self):
        ...
        # Icon 1: Clock
        clock_icon = QLabel()
        clock_pixmap = QPixmap("clock.png").scaled(1024 // 12 * 3 // 4, 1024 // 12 * 3 // 4, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        ...
        # Icon 2: Edit
        edit_icon = QLabel()
        edit_pixmap = QPixmap("edit.png").scaled(1024 // 12 * 3 // 4, 1024 // 12 * 3 // 4, Qt.KeepAspectRatio, Qt.SmoothTransformation)
