...
Exit:
    ...
    begin
        ...
        set property `calendar` of Result to property `calendar` of Map
        put property `calendar-data` of Map into Temp
        if Temp is not empty set property `calendar-data` of Result to Temp
    end
