...
echo `date` -- wget https://raw.githubusercontent.com/easycoder/rbr/refs/heads/main/roombyroom/Server/rbrheating.com/ui/dist.tgz
wget https://raw.githubusercontent.com/easycoder/rbr/refs/heads/main/roombyroom/Server/rbrheating.com/ui/dist.tgz
...
if test -f "dist.tgz"; then
    ...
    sudo -u linaro tar zxf dist.tgz
