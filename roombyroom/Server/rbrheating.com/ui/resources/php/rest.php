<?php
    ...
    require '/home/rbrheating/rbrheating.com/home/PHPMailer/src/Exception.php';
    require '/home/rbrheating/rbrheating.com/home/PHPMailer/src/PHPMailer.php';
    require '/home/rbrheating/rbrheating.com/home/PHPMailer/src/SMTP.php';
...
//      logger(substr($_SERVER['PATH_INFO'], 1));
    ...
    function get($conn, $action, $request, $smtpusername, $smtppassword) {
        ...
        switch ($action) {
            ...
            case 'test':
                // A test endpoint to do arbitrary things
            ...
            case 'testread':
                ...
                $mac = trim($request[0]);
                $password = trim($request[1]);
                $result = query($conn, "SELECT * FROM systems WHERE mac='$mac'");
                if ($row = mysqli_fetch_object($result)) {
                    $test = $row->test;
                    print $test;
                } else {
...
//                     // looger("UPDATE systems SET map='$map' WHERE mac='$mac'");
            ...
            case 'sendmail':
                // Send an email
                // Endpoint: {site root}/resources/php/rest.php/sendmail/{mac}/{password}
    ...
    function sendMail($data)
    {
        ...
        try {
            ...
            //Recipients
            $mail->setFrom('admin@rbrheating.com', 'RBR Heating');          //This is the email your form sends From
